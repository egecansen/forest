...
// cannot know which files that installer writes. The other two are refutable by
// content checks that are not performed: a kit whose `hooks/` directory exists
// but is empty, and a kit whose `settings.hooks.json` is present but not valid
// JSON. Everything else is refutable, and refuted where it is false.
//
