      ...
      if (url === '/api/worktree/remove-units') {
        ...
        for (const u of units) {
          ...
          try {
            ...
            // Human words to the caller — they land in an alert box — and the
            // raw error to the journal, where the syscall and path are useful.
            refused.push({ id, reason: removeFailureReason(e, kind, id) });
